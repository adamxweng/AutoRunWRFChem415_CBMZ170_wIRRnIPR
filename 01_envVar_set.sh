...
export targetwrfchemdir=$irrjwlwrf415s1
...
&time_control
 ...
 auxhist9_outname  = "./IRR_DIAG_d<domain>_<date>_170_base415_noPBLnudging"
 auxhist9_interval = 60, 60
 frames_per_auxhist9 = 24, 1 !output frame, 24 hours a file
 io_form_auxhist9    = 2
 history_outname = './wrfout_d<domain>_<date>_170_base_noPBLnudging'
 /
