...
export targetwrfchemdir=$cbmz1704binirrjwl415s1
...
#==== This is for IRR, echo all to wrfchem_irr_diag_d01 =============
...
&time_control
 ...
 auxhist9_outname  = "./IRR_DIAG_d<domain>_<date>_170_base415_4bwetcldnoPBLnudg"
 auxhist9_interval = 60, 60
 frames_per_auxhist9 = 24, 1 !output frame, 24 hours a file
 io_form_auxhist9    = 2
 history_outname = './wrfout_d<domain>_<date>_170_base_4bwetcldnoPBLnudg'
 /
 ...
 chem_opt                            = 170, 202, 202,             ! chemistry option, 201 = MOZART-MOSAIC (4 bins + simplified SOA + no aqeuous chemistry), 202 = MOZART-MOSAIC (4 bins + VBS SOA + aqeuous chemistry).
...
&time_control
 ...
 !irr_opt = 1
 kemit                               = 8,         ! number of vertical levels in the emissions input data file
 chem_opt                            = 0!170, 202, 202,             ! chemistry option, 201 = MOZART-MOSAIC (4 bins + simplified SOA + no aqeuous chemistry), 202 = MOZART-MOSAIC (4 bins + VBS SOA + aqeuous chemistry).
 bioemdt                             = 30, 3.0, 3.0,              !* set as previous self-test run, timestep, biogenic, minutes
 photdt                              = 30., 10., 10.,             ! timestep, photolysis, minutes
 chemdt                              = 6, 3.0, 3.0,               !* set as previous self-test run, timestep, chemistry, minutes
 io_style_emissions                  = 1,                         ! anthropogenic emissions, files, two 12-h emissions data files used
